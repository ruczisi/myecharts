...
(function ($) {
    ...
    $.extend(Constructor.prototype, {
        ...
        value2input: function(value) {
            this.$input.val(value).trigger('change', true); //second argument needed to separate initial change from users's click (for autosubmit)
        },
...
(function ($) {
    ...
    $.extend(Constructor.prototype, {
        ...
        /*
         ...
         users must pick some value from list, otherwise `null` returned.
